		...
		<div class="row">
			<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
				...
				<div class="block1 wrap-pic-w">
					...
					<a href="<?= base_url('user/women'); ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?= $t['kategori_nama']; ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<form action="<?= base_url('user/tambah_cart'); ?>" method="POST">
								<input type="hidden" name="id" value="<?php echo $t['produk_id']; ?>" />
								<input type="hidden" name="nama" value="<?php echo $t['produk_nama']; ?>" />
								<input type="hidden" name="harga" value="<?php echo $t['produk_harga']; ?>" />
								<input type="hidden" name="gambar" value="<?php echo $t['produk_gambar1']; ?>" />
								<input type="hidden" name="qty" value="1" />
								<input type="submit" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" value="Add To Cart">
							</form>
						</div>
